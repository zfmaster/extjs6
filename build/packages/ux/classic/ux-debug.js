...
Ext.define('Ext.ux.form.TinyMCETextArea', {extend:'Ext.form.field.TextArea', alias:['widget.tinymce_textarea', 'widget.tinymce_field'], wysiwygIntialized:false, intializationInProgress:false, lastHeight:null, lastFrameHeight:null, noWysiwyg:false, tinyMCEConfig:{}, liquidLayout:false, afterRender:function() {
  var me = this;
  me.callParent(arguments);
  ...
  var marker = '\x3ca id\x3d"_____sys__11223___"\x3e\x3c/a\x3e';
  ...
  if (me.tinyMCEConfig.readonly) {
    me.reinitEditor({readonly:false});
  }
  return result;
  ...
  if (readOnly !== me.tinyMCEConfig.readonly) {
    me.reinitEditor({readonly:readOnly});
  }
  return result;
